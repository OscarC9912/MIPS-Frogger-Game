...
# =================================== Car0 Drawing and Shifting Ends =========================================



# =================================== Car1 Drawing and Shifting Ends =========================================
CarDrawingRow1:	
	carDraw1:
		lw $t0, displayAddress
...
# =================================== Car2 Drawing and Shifting Ends =========================================
CarDrawingRow2:	
	carDraw2:
		lw $t0, displayAddress
...
DRAW_BACKGROUND:
	...
	lw $ra, 0($sp)
	addi $sp, $sp, 4
# =============================== Drawing the entire background Ends ===============================	
...
reachGoalArea2:
	...
	beq $t2, $t3, drawScoredFrog2

	jr $ra

drawScoredFrog2:
	j SuccessGameDisplay2
...
# =============================================== Death Judgement and Display Ends =================================================
...
DrawAlligator: 
	...
	AlligatorDrawEnd:
		...
		li $a0, 800
        	...
        	# === Update ends here ====
		jr $ra
# =========================================== Draw the Alligator Ends ===========================================




			
# ====================================== Froger1 Key Reaction ==================================== 	
key_A:
	addi $sp, $sp, -4
	sw $ra, 0($sp)
